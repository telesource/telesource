    ...
    <List>
      ...
      <Collapse in={servicesOpen} timeout="auto" unmountOnExit>
        <List component="div" disablePadding>
          <Link href="/conversational-ai" passHref><ListItem button><ListItemText primary="Conversational AI" /></ListItem></Link>
          <Link href="/tele-calling-solutions" passHref><ListItem button><ListItemText primary="Telecalling Solutions" /></ListItem></Link>
      ...
      <Collapse in={productsOpen} timeout="auto" unmountOnExit>
        <List component="div" disablePadding>
          ...
          <Link href="/ecommerce-plugin" passHref><ListItem button><ListItemText primary="Ecommerce Plugin" /></ListItem></Link>
          <Link href="/whatsapp-api" passHref><ListItem button><ListItemText primary="WhatsApp API" /></ListItem></Link>
      ...
      <Collapse in={businessOpen} timeout="auto" unmountOnExit>
        <List component="div" disablePadding>
          ...
          <Link href="/government" passHref><ListItem button><ListItemText primary="Government" /></ListItem></Link>
  ...
  const desktopMenuItems = (
    <Box sx={{ flexGrow: 1, display: 'flex', justifyContent: 'flex-end', alignItems: 'center' }}>
      ...
      <Menu
        ...
        onClose={handleClose}
      >
        <Link href="/conversational-ai" passHref><MenuItem onClick={handleClose}>Conversational AI</MenuItem></Link>
        <Link href="/tele-calling-solutions" passHref><MenuItem  onClick={handleClose}>Telecalling Solutions</MenuItem></Link>
      ...
      >
        ...
        <Link href="/whatsapp-api" passHref><MenuItem onClick={handleClose}>WhatsApp API</MenuItem></Link>
        <Link href="/ecommerce-plugin" passHref><MenuItem onClick={handleClose}>Ecommerce Plugin</MenuItem></Link>
      ...
      >
        ...
        <Link href="/government" passHref><MenuItem onClick={handleClose}>Government</MenuItem></Link>
